...
int main() {
  ...
  double gametime = ((double)gametime.tv_sec - (double)start.tv_sec) + 0.000001 * ((double)gametime.tv_usec - (double)start.tv_usec);
  ...
  while (running && gametime <= 180) {
    ...
    gettimeofday(&gameclock, NULL);
    gametime = ((double)gametime.tv_sec - (double)start.tv_sec) + 0.000001 * ((double)gametime.tv_usec - (double)start.tv_usec);
    usleep(10000);
  }
